...
class WordsParser(HTMLParser):
    ...
    search_tags = ['p', 'div', 'span', 'a', 'h1', 'h2', 'h2', 'h3', 'h4', 'href']
    # current tag
    current_tag = ''
        ...
        if self.current_tag in self.search_tags:
            ...
            for word in data.strip().split():
                ...
                if (
                       ...
                       common_word not in ['the', 'and', 'all', 'reddit','comments','vote', 'has', 'been', 'are','share','has', 'posted'] and
...
if __name__ == '__main__':
    ...
    #url = 'https://www.reddit.com/r/wallstreetbets/comments/qvwu4g/daily_discussion_thread_for_november_17_2021/'
